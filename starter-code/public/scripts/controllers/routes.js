...
// Carson here. Remember that the parameters necessary for the page.js routes are the URLs (look in index.html) and the callback functions associated with the URLs (look in articleController.js && aboutController.js). YOU GOT THIS.
